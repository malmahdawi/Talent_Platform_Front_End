...
import CheckOffersTable from "./CheckOffersTable.js"
...
export default function CheckOffersContainer(props) {
        ...
        <div className={classes.section} >
            <div className={classes.container} >
                    <div className="cd-section" id="contentAreas">
                        <div id="tables">
                            <GridContainer>
                                <CheckOffersTable offers={props.offers} handleAction={props.handleAction}/>
                            </GridContainer>
                            </div>
                        </div>
                </div>
